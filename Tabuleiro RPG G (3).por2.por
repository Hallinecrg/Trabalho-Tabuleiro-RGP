programa
{
	...
	funcao inicio()
	{
		...
		cadeia letra
          ...
          escreva("Digite um número positivo para jogar ⚔(°◡°)⚔ \n","\n")
          leia(letra)
          escreva ("\n")
       ...
       enquanto(jogar>=0)
       {
        ...
        enquanto(casa1<20 e casa2<20 e jogar>=0)
        {
        	...
        	escreva("Jogador ",jogador, " digite qualquer número positivo para rodar seu dado: \n")
        	escreva("\n")
        	leia(letra)
        	...
        	escreva ("\n")
        	 ...
        	 se (dado>=0 ou dado<0 e jogador==1){
        	     ...
        	     se(casa1==7)
        	     {
        	     	...
        	     	escreva("Jogador ", jogador, " digite qualquer número para rodar seu dado \n")
        	          leia(dado)
        	     ...
        	     se(casa1==15)
        	     {
        	     	...
        	     	escreva("O jogador 1 cantou alguma canção ? ( escreva um numero positivo para sim e um numero negativo para não ",("\n"))
        	     	leia(Cancao)
          ...
          se(jogar>0)
          {
            escreva("Deseja continuar? Número positivo para sim e número negativo para não \n")
		  leia(jogar)
